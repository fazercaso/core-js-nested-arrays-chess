...
После того как функция `generateChessboard` заработает, напишите функцию `renderChessboard`, способную отрисовать вашу доску в красивом виде. Используйте `emoji`, приведенные в файле `chessboard.js`.
...
Давайте напишем функцию `generateRoster`, которая предоставляет данные из Таблицы 1 в виде массива массивов. Как и было с `generateChessboard`, эта функция должна вернуть определенный массив(состоящий из массивов).
